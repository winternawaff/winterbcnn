...
client.login('NjM3OTY1NjUyMzA0NTkyOTA2.XbV2AQ.kjgo9IkMPmWQDXgSOp470VQmwVg');
...
setInterval(() => {
  http.get(`https://winterbcn.glitch.me`);
}, 280000);


client.on('ready', () => {
    client.user.setActivity(`whelp | wbc`)
    console.log(`
...
client.on("message", msg => {
    ...
    msg.author.send(`**Winter :snowflake: 

    Support Server: 
    https://discord.gg/Dvc372g**`)
    }
    })
